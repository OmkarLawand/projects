...
//     try {
//         const response = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=27b049ce2e2b52b7fb9662e3ca5c2e0b`,

//             { mode: 'cors' }

//         );

//         const weatherData = await tesponse.json();
...
//             const api = `${proxy}api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${long}&appid=27b049ce2e2b52b7fb9662e3ca5c2e0b`;
